...
#define CE_usart_tx_gpio4 1 // Teensy TX
#define CE_usart_rx_gpio5 0 // Teensy RX
...
*/
 ...
 #define latchPin CE_usart_tx_gpio4
 #define dataPin CE_spi_cs_gpio3
 #define clockPin CE_spi_clk_gpio2
